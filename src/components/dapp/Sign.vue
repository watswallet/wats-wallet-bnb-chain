<template>
    <div class="w-90 h-150 flex flex-col bg-slate-50 dark:bg-[#09090b] text-slate-900 dark:text-white font-sans relative overflow-hidden selection:bg-emerald-500/30 transition-colors duration-300">
        <div class="absolute top-0 left-0 right-0 h-48 bg-linear-to-b from-emerald-500/5 dark:from-emerald-900/10 to-transparent pointer-events-none transition-colors duration-300"></div>

        <div class="flex-1 flex flex-col justify-between relative px-6 py-3 overflow-y-auto custom-scrollbar z-10">
            <div class="flex flex-col gap-6">
                <div class="flex flex-col items-center gap-3 mt-2">
                    ...
                    <div class="text-center space-y-0.5">
                        <h2 class="text-lg font-bold text-slate-900 dark:text-white tracking-tight transition-colors duration-300">{{ $t('dapps.sign.title') }}</h2>
                        <p class="text-xs font-mono text-slate-500 dark:text-zinc-400 bg-slate-100 dark:bg-zinc-800/50 px-2 py-0.5 rounded-full border border-slate-200 dark:border-white/5 inline-block transition-colors duration-300">{{ host }}</p>
                    </div>
                </div>
